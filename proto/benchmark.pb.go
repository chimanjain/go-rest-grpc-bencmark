...
func (x *ProcessRequest) GetPayload() string {
	if x != nil {
		return x.Payload
	}
	return ""
...
const file_proto_benchmark_proto_rawDesc = "" +
	...
	"\x06result\x18\x02 \x01(\tR\x06result2Z\n" +
	"\x10BenchmarkService\x12F\n" +
	"\vProcessData\x12\x19.benchmark.ProcessRequest\x1a\x1a.benchmark.ProcessResponse\"\x00B4Z2github.com/chimanjain/go-rest-grpc-benchmark/protob\x06proto3"
...
var file_proto_benchmark_proto_goTypes = []any{
	(*ProcessRequest)(nil),  // 0: benchmark.ProcessRequest
	(*ProcessResponse)(nil), // 1: benchmark.ProcessResponse
}
var file_proto_benchmark_proto_depIdxs = []int32{
	0, // 0: benchmark.BenchmarkService.ProcessData:input_type -> benchmark.ProcessRequest
	1, // 1: benchmark.BenchmarkService.ProcessData:output_type -> benchmark.ProcessResponse
